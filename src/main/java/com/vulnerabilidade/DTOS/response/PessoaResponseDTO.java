...
public record PessoaResponseDTO(Long pessoa_id,                                String pessoa_cpf, 
                               ...
                               Boolean pessoa_esta_trabalhando,                String pessoa_trabalho,
                               Float pessoa_salario){
  ...
  public PessoaResponseDTO(Pessoa pessoa){
    ...
    this( pessoa.getPessoa_id(), 
          ...
          pessoa.getPessoa_esta_trabalhando(),
          pessoa.getPessoa_trabalho(),
          pessoa.getPessoa_salario());
  }
